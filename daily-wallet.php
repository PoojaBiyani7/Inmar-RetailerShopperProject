...
echo "<br/><br/><br/><table width=70% align=center text-align=center border='1'><tr><th>Transaction Date</th><th>Shopper ID</th><th>Retailer ID</th><th>Retailer Wallet</th></tr>";
	...
	{
		$retailerWallet=$retailerWallet+$rowW['sum(retailerWallet)'];
		echo "The retailer's Wallet on " . $date . " is :  " . $retailerWallet . "<br/>";
	}
	else
		echo "The retailer's Wallet on " . $date . " is :  " . $retailerWallet . "<br/>";
	
	 echo "<h2>The Details Of Transactions on " . $date . " are : </h2><br/><br/>";
...
?>
	...
	<a href="retailer-wallet.php">MY_TOTAL_WALLET</a><br/><br/>
	</body>
