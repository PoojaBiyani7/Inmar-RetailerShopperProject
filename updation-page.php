...
echo "Session Variable Value Retailer Id -" . $id . "<br/><br/>";
...
<h3> Want to add a another Variety? <h3/>
<br/>
<form method="POST" action="add-variety.php">
<input type="text" name="f" placeholder="Fruit Name"><input type="number" name="q" placeholder="Quantity"><input type="number" step="0.01" name="p" placeholder="Price"><br/><br/>
<input type="submit" name="submit" value="Add a new Variety">
</form>
